    ...
    <body class="bg-slate-100 font-sans"> 
        <div class="flex min-h-screen"> 
            <aside class="w-64 bg-slate-800 text-white flex flex-col"> 
                <div class="p-6 text-center border-b border-slate-700"> <a href="dashboard.php"><img src="../assets/images/INEC-Admin-Logo.png" alt="INEC Logo" class="h-14 w-auto mx-auto"></a> 
                </div>                 
