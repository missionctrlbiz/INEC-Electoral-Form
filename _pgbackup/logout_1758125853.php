...
// The header() function is the primary method for redirection.
// The exit() function stops the script from running further.
header("location: ../index.php");
exit;

// The HTML below is a fallback in case the header() redirect fails for any reason.
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <!-- IMPORTANT: This meta tag will automatically redirect to the root index.php after 3 seconds -->
        <meta http-equiv="disable-refresh" content="3;url=../index.php">
        ...
        <div class="flex min-h-screen items-center justify-center px-4">
            <div class="w-full max-w-md text-center">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg border border-slate-200">
                    ...
                    <p class="mt-2 text-slate-600">You will be redirected to the home page shortly.</p>
                </div>
