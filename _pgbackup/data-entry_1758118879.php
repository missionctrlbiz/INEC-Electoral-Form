...
<html lang="en">
    ...
    <body class="bg-slate-50 font-sans text-slate-700">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-10 border border-slate-200">
                ...
                <div class="bg-slate-50 border border-dashed border-slate-300 rounded-lg p-4 mb-8 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-600"> <span class="font-semibold"> <!-- PHP Placeholder for user's name -->
                            John Doe </span> 
                        (<span class="text-slate-500"> <!-- PHP Placeholder for user's email -->
                            you@example.com </span>) </p>
                    </div>
                </div>
                <!-- CORRECTED: Stepper Structure and Styling -->
                <div class="flex items-center mb-10">
                    <div class="step active flex flex-col items-center w-auto">
                    ...
                    <div class="connector flex-1 h-1 bg-gray-200 transition-all duration-300 mx-2" data-connector="1"></div>
                    <div class="step flex flex-col items-center w-auto">
                    ...
                    <div class="connector flex-1 h-1 bg-gray-200 transition-all duration-300 mx-2" data-connector="2"></div>
                    <div class="step flex flex-col items-center w-auto">
                    ...
                    <div class="connector flex-1 h-1 bg-gray-200 transition-all duration-300 mx-2" data-connector="3"></div>
                    <div class="step flex flex-col items-center w-auto">
                ...
                <form id="electionForm" method="POST" action="submit-result.php" enctype="multipart/form-data">
                    ...
                    <div class="form-step hidden" data-step="4">
                        <!-- ... Step 4 content with styled file upload ... -->
        ...
        <div id="cancel-modal" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 transition-opacity duration-300 opacity-0 hidden">
            <div class="bg-white rounded-xl shadow-2xl p-8 text-center w-full max-w-md transform transition-all duration-300 opacity-0 scale-95">
                ...
                <div class="flex justify-center gap-4">
                    <button id="cancel-exit-btn" type="button" class="bg-slate-200 font-semibold w-full py-3 rounded-lg hover:bg-slate-300 transition-colors">No, Stay</button><a href="index.php" class="bg-inec-red text-white font-semibold w-full py-3 rounded-lg hover:opacity-90 transition-opacity">Yes, Exit</a>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            stateSelect.addEventListener('change', function() { /* ... Lga population logic ... */ lgaSelect.innerHTML = '<option value="" selected disabled>Select LGA...</option>'; wardSelect.innerHTML = '<option value="" selected disabled>Select Ward...</option>'; lgaSelect.disabled = true; wardSelect.disabled = true; if (this.value && electoralData[this.value]) { lgaSelect.disabled = false; for (const lga in electoralData[this.value]) { lgaSelect.add(new Option(lga, lga)); } } });
            lgaSelect.addEventListener('change', function() { /* ... Ward population logic ... */ wardSelect.innerHTML = '<option value="" selected disabled>Select Ward...</option>'; wardSelect.disabled = true; const state = stateSelect.value; if (this.value && electoralData[state][this.value]) { wardSelect.disabled = false; electoralData[state][this.value].forEach(ward => wardSelect.add(new Option(ward, ward))); } });
            ...
            const updateView = () => {
                ...
                stepperItems.forEach((step, index) => {
                    ...
                    if (index < currentStep) {
                        ...
                        icon.innerHTML = ''; // Clear number for checkmark
            ...
            const populateReview = () => { /* ... populate review logic ... */ };
