        ...
        <div class="container mx-auto px-6">
            <header class="sticky top-0 z-40 bg-white"> 
                <nav class="flex items-center justify-between flex-wrap py-4 border-b border-slate-200"> 
                    <!-- LOGO -->
                    <a href="#" class="flex items-center"> <img src="INEC-Logo.png" alt="INEC Logo" class="h-14 w-auto"> </a> 
                    <!-- HEADER BUTTONS -->
                    <div class="flex items-center gap-4">
                        <a href="#learn" class="bg-slate-100 font-semibold inline-block px-6 py-3 rounded-lg text-slate-800 hover:bg-slate-200 transition-colors">Learn More</a> <a href="#start" class="bg-inec-green font-semibold inline-block px-6 py-3 rounded-lg text-white hover:opacity-90 transition-opacity shadow-md">Get Started</a> 
                    </div>
                </nav>                 
            </header>
            <main>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                            ...
                            <div class="bg-white border border-slate-200 rounded-lg p-8 text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                                ...
                                <div class="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <i class="bi bi-file-earmark-text-fill text-4xl text-blue-600"></i>
                                </div>
                                <ul class="text-left space-y-2 text-slate-600 mb-8 flex-grow">
                                    <li><i class="bi bi-check-circle-fill text-inec-green mr-2"></i> Step 1: Polling Unit Information
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-green mr-2"></i> Step 2: Voter & Ballot Statistics
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-green mr-2"></i> Step 3: Political Party Scores
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-green mr-2"></i> Step 4: Review & Attach Document
                                    </li>
                                </ul>
                            ...
                            <div class="bg-white border border-slate-200 rounded-lg p-8 text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                                ...
                                <div class="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <i class="bi bi-speedometer2 text-4xl text-inec-red"></i>
                                </div>
                                <ul class="text-left space-y-2 text-slate-600 mb-8 flex-grow">
                                    <li><i class="bi bi-check-circle-fill text-inec-red mr-2"></i> Real-time election analytics
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-red mr-2"></i> Detailed result verification
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-red mr-2"></i> User and access management
                                    </li>
                                    <li><i class="bi bi-check-circle-fill text-inec-red mr-2"></i> Export and reporting tools
                                    </li>
                                </ul>
                                <a href="admin-login.php" class="bg-slate-700 font-semibold inline-block px-8 py-3 rounded-md text-white hover:bg-slate-800 transition-colors">Access Admin Portal</a>
                            </div>
                        </div>
                    </div>
                </div>
