...
<head>
    ...
    <!-- Paths are updated to go up one directory (../) to the assets folder -->
...
<body class="bg-slate-50 font-sans text-slate-700">
    ...
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="w-full max-w-md space-y-8">
            ...
            <!-- Form action updated to point to the core processing script -->
            <form class="mt-8 space-y-6 bg-white p-8 rounded-xl shadow-lg border border-slate-200" action="../core/process_login.php" method="POST">
                <!-- This hidden input tells the script which login form is being submitted -->
